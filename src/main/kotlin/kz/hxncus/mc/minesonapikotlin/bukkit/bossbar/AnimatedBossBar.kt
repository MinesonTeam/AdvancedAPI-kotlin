...
import kz.hxncus.mc.minesonapikotlin.bukkit.bossbar.animation.Animatable
import kz.hxncus.mc.minesonapikotlin.bukkit.bossbar.animation.AnimationType
import kz.hxncus.mc.minesonapikotlin.util.timerAsync
import org.bukkit.scheduler.BukkitScheduler

/**
 * The type Animated a boss bar.
 * @author Hxncus
 * @since  1.0.1
 */
class AnimatedBossBar (private val animationType: AnimationType, private val delay: Long, private val period: Long) : SimpleBossBar(),
    Animatable {
