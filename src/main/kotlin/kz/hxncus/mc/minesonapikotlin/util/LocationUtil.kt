 ...
 */
fun Location.getMinAndMaxVector(location: Location): Pair<Vector, Vector> {
    val boundingBox = BoundingBox.of(this, location)
 ...
 * @return the min and max vector
 */
fun Location.getMinAndMaxVector(x: Double, y: Double, z: Double): Pair<Vector, Vector> {
